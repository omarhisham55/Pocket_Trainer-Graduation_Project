    ...
    List<Widget> pages = [
      Center(
        child: Column(
          ...
          children: [
            const Icon(Icons.notifications_none_outlined, size: 400, color: BackgroundColors.whiteBG),
            Padding(
                padding: const EdgeInsets.symmetric(horizontal: 10.0),
                child: subTitleText(text: "We'll notify you when we have news to share about your training",
                            ...
                            [
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    subTitleText(text: "Title", maxLines: 1, textOverflow: TextOverflow.ellipsis),
                                    const SizedBox(height: 5),
                                    Row(
                                      children: [
                                        Expanded(child: paragraphText(text: "Content", textOverflow: TextOverflow.ellipsis, maxLines: 2)),
                                        paragraphText(text: "02:00 pm")
                                      ],
                                    ),
                                  ],
                                ),
