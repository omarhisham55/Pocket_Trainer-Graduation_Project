...
class GymRecommendedPlan extends StatelessWidget {
  ...
  const GymRecommendedPlan({Key? key, this.fromHome, this.fromProfile})
      : super(key: key);
      ...
      child: BlocConsumer<CubitManager, MainStateManager>(
        ...
        builder: (_, s) {
          return FutureBuilder(
              ...
              builder: (_, snapshot) {
                if (snapshot.hasData) {
                  List requirements = snapshot.data!;
                  List trainingDays = [];
                  ...
                  return WillPopScope(
                    ...
                    child: Scaffold(
                      ...
                      appBar: AppBar(
                          ...
                          title: Center(
                              child: titleText(text: 'Diet information')),
                          actions: [
                            Visibility(
