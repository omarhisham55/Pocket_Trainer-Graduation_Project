                  ...
                  if(snapshot.hasData){
                    return ListView.separated(
                        itemBuilder: (_, i) => DefaultButton(
                          function: (){
                            print(type);
                            pageNavigator(context, InformationDetails(exerciseType: snapshot.data![i]));
                          },
                        ...
                        itemCount: snapshot.data!.length //$number of body parts
                    );
                  }
                  else if (snapshot.hasError) {
                    return Center(child: titleText(text: "Error fetching data ${snapshot.error}"));
                  } else {
